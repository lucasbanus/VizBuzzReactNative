  ...
  if (props.episodesImage === "") {
    image = (
      <Image
        ...
        source={{
          uri:
            "https://macfarlaneoffice.com/wp-content/uploads/2020/03/no_image.jpg"
        }}
      />
    );
  } else {
  ...
  if (props.loadingEpisodes) {
    ...
    mainComp = (
      <View style={styles.mainContainer}>
        ...
        {image}
        <ScrollView>{episodes}</ScrollView>
      </View>
    );
  }
  return <View>{mainComp}</View>;
};
